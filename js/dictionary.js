...
noun[2590]="sector";
noun[2591]="security";
//this generator was made by LQ16! https://github.com/LQ16/
noun[2592]="sediment";
noun[2593]="seed";
noun[2594]="segment";
noun[2595]="selection";
...
document.myForm.theDomain.value=noun[targetNoun] + "." + tld[targetTLD];
         }
...
function newDomain3() {
  ...
  var targetAdj = Math.round(Math.random() * 1124);
  var targetNoun = Math.round(Math.random() * 3260);
  var targetVerb = verbs[Math.round(Math.random() * 633)];
  var targetTLD = Math.round(Math.random() * 3);
  document.myForm.theDomain.value=adj[targetAdj]+ "-" + noun[targetNoun] + "-" + targetVerb + "." + tld[targetTLD];
                  }
...
var targetNoun = Math.round(Math.random() * 3260);
var targetVerb = verbs[Math.round(Math.random() * 633)];
var targetAdverb = adverbs[Math.round(Math.random() * 633)];
var targetTLD = Math.round(Math.random() * 3);
document.myForm.theDomain.value=adj[targetAdj]+ "-" + noun[targetNoun] + "-" +  targetVerb + "-" + targetAdverb +"." + tld[targetTLD];
                                    }
